...
def ping():
    ...
    with open(
        "/home/dbhausen/RestReact/rest-react/frontend/src/Components/Links/linksIn.json",
        "r",
    ) as f:
        links = json.load(f)
        ...
        with open(
            "/home/dbhausen/RestReact/rest-react/frontend/src/Components/Links/links.json",
            "w",
        ) as f:
